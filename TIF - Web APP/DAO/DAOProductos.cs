...
namespace DAO
{
    public class DAOProductos
    {
        ...
        {
            string consulta = "Select * From Producto WHERE Nombre = '" + prod.Nombre1 + "' AND Precio = '" + prod.Precio1.ToString().Replace(',', '.') + "' AND Descripción LIKE '" + prod.Descripcion1 + "'" + " AND Estado = '" + prod.Estado1 + "'";
